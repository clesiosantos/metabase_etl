-- INCIDENTES (tipo_chamado = 'Incidente')

-- Regra: Excluir da volumetria incidentes abertos por zabbix com prioridade=3 (Média)
-- NOTA: A regra é aplicada na cláusula WHERE via exclusão.
...
-- 2) Volumetria por Cliente (Incidentes)
SELECT
